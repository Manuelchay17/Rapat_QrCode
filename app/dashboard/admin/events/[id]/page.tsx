...
export default async function EventDetailPage({ params }: PageProps) {
  ...
  // --- Penambahan Logika Expired Dinamis ---
  const isExpired = eventDateTime < now && !event.isManualOpen;
  // -----------------------------------------

  const eventDataFormatted = {
    ...event,
    rapat_type: event.rapat_type as "with_reg" | "no_reg",
    isManualOpen: event.isManualOpen || false, // Penambahan: Kirim status awal ke Client Component
  };
